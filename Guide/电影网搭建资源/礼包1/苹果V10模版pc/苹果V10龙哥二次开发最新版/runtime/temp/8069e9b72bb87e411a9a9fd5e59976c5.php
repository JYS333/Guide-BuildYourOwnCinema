<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"template/default_pc/html/vod\play.html";i:1525153591;s:63:"D:\PHPTutorial\WWW\template\default_pc\html\public\include.html";i:1522757228;s:60:"D:\PHPTutorial\WWW\template\default_pc\html\public\head.html";i:1525097738;s:60:"D:\PHPTutorial\WWW\template\default_pc\html\public\foot.html";i:1522416581;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5ae9f2d8ea931=explode(',',$maccms['search_hot']); if(is_array($_5ae9f2d8ea931) || $_5ae9f2d8ea931 instanceof \think\Collection || $_5ae9f2d8ea931 instanceof \think\Paginator): if( count($_5ae9f2d8ea931)==0 ) : echo "" ;else: foreach($_5ae9f2d8ea931 as $key2=>$vo2): ?>
...
<div class="bread-crumb-nav fn-clear">
    <ul class="bread-crumbs">
        <li class="home"><a href="<?php echo $maccms['path']; ?>">首页</a></li><li><a href="列表页.html">电影</a></li>
        <li><a href="<?php echo mac_url_type($obj['type']); ?>"><?php echo $obj['type_name']; ?></a></li>
