<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"D:\PHPTutorial\WWW/application/admin\view\vod\index.html";i:1524715632;s:58:"D:\PHPTutorial\WWW\application\admin\view\public\head.html";i:1522628860;s:58:"D:\PHPTutorial\WWW\application\admin\view\public\foot.html";i:1522628860;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form " method="post">
                ...
                <div class="layui-input-inline w150">
                    <select name="level">
                        ...
                        <option value="9" <?php if($param['level'] == '9'): ?>selected <?php endif; ?>>推荐9</option>
                    </select>
                </div>
                <div class="layui-input-inline w150">
                    <select name="lock">
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td>[<?php echo $vo['type']['type_name']; ?>] <a target="_blank" class="layui-badge-rim " href="<?php echo mac_url_vod_detail($vo); ?>"><?php echo $vo['vod_name']; ?></a> <?php if($vo['vod_status'] == 0): ?> <span class="layui-badge">未审</span><?php endif; if($vo['vod_lock'] == 1): ?> <span class="layui-badge">锁定</span><?php endif; ?> </td>
