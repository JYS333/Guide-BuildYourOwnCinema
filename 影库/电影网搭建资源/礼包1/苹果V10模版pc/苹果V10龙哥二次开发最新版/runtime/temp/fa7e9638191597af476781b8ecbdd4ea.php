<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:40:"template/default_pc/html/vod\detail.html";i:1525153500;s:63:"D:\PHPTutorial\WWW\template\default_pc\html\public\include.html";i:1522757228;s:60:"D:\PHPTutorial\WWW\template\default_pc\html\public\head.html";i:1525097738;s:61:"D:\PHPTutorial\WWW\template\default_pc\html\public\star2.html";i:1518097631;s:60:"D:\PHPTutorial\WWW\template\default_pc\html\public\foot.html";i:1522416581;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_5ae9f2d6cf728=explode(',',$maccms['search_hot']); if(is_array($_5ae9f2d6cf728) || $_5ae9f2d6cf728 instanceof \think\Collection || $_5ae9f2d6cf728 instanceof \think\Paginator): if( count($_5ae9f2d6cf728)==0 ) : echo "" ;else: foreach($_5ae9f2d6cf728 as $key2=>$vo2): ?>
...
<div class="ui-box marg" id="downlist_<?php echo $key; ?>">
    ...
    <div class="down_list">
        ...
        <div class="downtools"><input id="allcheck<?php echo $key; ?>" onclick="CheckAll(<?php echo $key; ?>)" type="checkbox" name="checkall"><em>全选</em><a href="javascript:void(0);" target="_self" class="thunder_down_all">迅雷批量下载</a><a href="javascript:void(0);" target="_self" class="xf_down_all">旋风批量下载</a><span class="xuanfu">※ 若点击迅雷下载无反应，请手动复制框内下载地址到迅雷软件即可边下边播 ※</span>
        </div>
    </div>
</div>
<?php endforeach; endif; else: echo "" ;endif; ?>
